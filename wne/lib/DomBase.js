...
(function(scope, undefined) {
    ...
    scope.merger(scope, {
        ...
        setViewportScale: function(landscape, scale, scalable) {
        ...
        calcWindowSize: function(landscape, max) {
            var size = {};
            ...
            if (window.devicePixelRatio == 1) {
                ...
                if (!browser.chrome && browser.android) {
                    ...
                    if (window.screen.height >= 1024) {
                        ...
                        setViewportScale(landscape, 0.5);
        ...
        getUrlParams: function() {
            ...
            var queryStr = scope.parseUrl(url).query;
            if (queryStr) {
        ...
        loadJS: function(jspath, onload, useAjax, id) {
            if (!jspath) {
                return false;
            }
        ...
        loadJSList: function(allJSList, onload, useAjax) {
            ...
            function loadNext(e) {
                ...
                if (loaded < total) {
                    ...
                    if (js) {
                        scope.loadJS(js, loadNext, useAjax);
                    } else {
                        loadNext({});
                    }
                } else if (onload) {
